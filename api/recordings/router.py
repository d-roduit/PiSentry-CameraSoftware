...
@router.get('/{recording_filename}')
def get_recording(request: Request):
    recording_filename = request.path_params['recording_filename']
    ...
    return range_requests_response(request, file_path=recording_filepath, content_type="video/mp4")
